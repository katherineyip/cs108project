...
public class RectShape extends Shape {
    ...
    public RectShape(int backgroundColor,
        ...
        this.backgroundColor = Color.GRAY; //TODO: for this extension, we should allow the user to select their own background color (and add this var to the super constructor on the above line)
    }
}